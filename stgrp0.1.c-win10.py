...
import ctypes
ctypes.windll.shcore.SetProcessDpiAwareness(1)  #para que no se vea borroso en win10
...
class Marcoder2: #InvHSCalculator
    def __init__(self):
        ...
        boton=tk.Button(marcoder[1], text="Calcular", command=lambda:Hscalc()).grid(row=9,column=0,padx=75,pady=15,sticky=("W"))
        boton2=tk.Button(marcoder[1], text="Borrar", command=lambda:Hscalc.borrarinvhs()).grid(row=9,column=0,padx=75,sticky=("E"))
...
class Marcoder3: #Stockprofitcalc
    def __init__(self):
        ...
        boton=tk.Button(marcoder[2], text="Calcular", command=lambda:StockGainsCalc()).grid(row=12,column=0,padx=15,pady=5,sticky=("E"))
        boton2=tk.Button(marcoder[2], text="Borrar", command=lambda:StockGainsCalc.borrar_stockgainscalc()).grid(row=12,column=1,padx=1,sticky=("W"))
...
class Marcoder4: #cuantoquieresganarcalc
    def __init__(self):
        ...
        boton=tk.Button(marcoder[3], text="Calcular", command=lambda:Cqg()).grid(row=13,column=0,padx=90,pady=15,sticky=("W"))
        boton2=tk.Button(marcoder[3], text="Borrar", command=lambda:Cqg.borrarcqg()).grid(row=13,column=0,padx=90,sticky=("E"))
...
class Marcoder6: #Bitcoin Calculator
    def __init__(self):
        ...
        boton=tk.Button(marcoder[5], text="Calcular", command=lambda:BitcoinCalc()).grid(row=15,column=0,padx=90,pady=15,sticky=("W"))
        boton2=tk.Button(marcoder[5], text="Borrar", command=lambda:None).grid(row=15,column=0,padx=90,sticky=("E"))
