...
class Marcoder6: #Bitcoin Calculator
    def __init__(self):
        ...
        boton=tk.Button(marcoder[5], text="Calcular", command=lambda:BitcoinCalc()).grid(row=15,column=0,padx=40,pady=15,sticky=("W"))
        boton2=tk.Button(marcoder[5], text="Borrar", command=lambda:None).grid(row=15,column=0,padx=40,sticky=("E"))
