...
class Marcoder6: #Bitcoin Calculator
    def __init__(self):
        ...
        boton=tk.Button(marcoder[5], text="Calculate", command=lambda:BitcoinCalc()).grid(row=15,column=0,padx=90,pady=15,sticky=("W"))
        boton2=tk.Button(marcoder[5], text="Clear", command=lambda:BitcoinCalc.borrarcqg()).grid(row=15,column=0,padx=90,sticky=("E"))
